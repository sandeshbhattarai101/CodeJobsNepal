...
with col1:
    st.markdown(
        "<img src='https://raw.githubusercontent.com/sandeshbhattarai101/CodeJobsNepal/main/codejobslogo.png' style='height: 6em;'>",
        unsafe_allow_html=True
    )
with col2:
            ...
            with st.container():
                ...
                st.markdown(
                    ...
                    <div class="job-card">
                        ...
                        <h4 style="margin-bottom: 10px;">{row['Job Title']}</h4>
